function doSourcestatisticsPrePstGLMnew(band,doplot,nrand)
...
cd('/analyse/4/Project0030/source/4DprepstGLMnew');
...
if doplot,
  cd /analyse/4/Project0030/figures/sourcedata/4DprepstGLMnew
