...
for m = 1:length(freqno)
  ...
  [statl,statr,stat] = doSourceanalysisDICSpre3(subject,frequency,smoothing);
  ...
  save([subject.name,'stat',num2str(frequency,'%03d'),'pre3_',num2str(round(10*smoothing),'%03d'),'.mat'],'statl','statr','stat');
