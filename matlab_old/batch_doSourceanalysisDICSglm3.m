...
for m = 1:length(freqno)
  ...
  [stat13,stat42,stat13b,stat42b] = doSourceanalysisDICSglm3(subject,frequency);
  warning off;
  ...
  save([subject.name,'stat',num2str(frequency,'%03d'),'glm3.mat'],'stat13','stat42','stat13b','stat42b');
