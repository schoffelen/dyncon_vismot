function doSourcestatisticsPrePstGLMstrat(band,doplot,nrand)
...
cd('/analyse/4/Project0030/source/4DprepstGLMstratified');
...
if doplot,
  cd /analyse/4/Project0030/figures/sourcedata/4DprepstGLMstratified
