function doSourcestatisticsPrePstGLM3(band,doplot,nrand)
...
cd('/analyse/4/Project0030/source/4DprepstGLM3');
...
if doplot,
  ...
  cd /analyse/4/Project0030/figures/sourcedata/4DprepstGLM3
