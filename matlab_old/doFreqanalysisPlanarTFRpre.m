function [allfreq] = doFreqanalysisPlanarTFRpre(subject,frequency,smoothing,twindow);
...
for k = 1:4
  ...
  cfg.output = 'pow';
  cfg.pad     = 1; %explicitly make nfft 1024
  cfg.foi     = frequency;
  cfg.toi     = [-0.79:0.01:-0.1];
