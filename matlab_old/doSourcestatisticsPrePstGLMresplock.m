function doSourcestatisticsPrePstGLMresplock(band,doplot,nrand)
...
cd('/analyse/4/Project0030/source/4DprepstGLMresplock');
...
if doplot,
  cd /analyse/4/Project0030/figures/sourcedata/4DprepstGLMresplock
