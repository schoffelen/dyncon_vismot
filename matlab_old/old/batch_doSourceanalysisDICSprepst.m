...
for m = 1:length(freqno)
  ...
  if subjno(k)>3
   [stat,stat13,stat42,stat13b,stat42b,stat13x,stat42x] = doSourceanalysisDICSprepst(subject,frequency,1);
  else
   [stat,stat13,stat42,stat13b,stat42b,stat13x,stat42x] = doSourceanalysisDICSprepst(subject,frequency);
  end
  warning off;
