...
for m = 1:length(freqno)
  ...
  [statlc, statli, statrc, statri] = doSourceanalysisDICSacPre(subject, frequency);
  ...
  cd([datadir,'source/']);
  save([subject.name,'stat',num2str(frequency,'%03d'),'acPreFastSlow.mat'],'statlc','statli','statrc','statri');
