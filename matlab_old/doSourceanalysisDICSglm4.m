function [stat13, stat42, stat13b, stat42b] = doSourceanalysisDICSglm4(subject, frequency)
...
for mm = 1:4
  ...
  rtvec                = freq.rt(indx)';
  cfg2.design(end+1,rtvec< median(rtvec)) = 1;   %rt regressor
  cfg2.design(end,  rtvec>=median(rtvec)) = -1;   %rt regressor
