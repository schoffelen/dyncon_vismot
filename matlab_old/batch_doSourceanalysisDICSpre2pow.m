...
for m = 1:length(freqno)
  ...
  [statlc, statli, statrc, statri] = doSourceanalysisDICSpre2pow(subject, frequency, smoothing)
  ...
  save([subject.name,'stat',num2str(frequency,'%03d'),'pre2pow_',num2str(round(10*smoothing),'%03d'),'.mat'],'statlc','statli','statrc','statri');
